...
namespace BoxAgr.BLL.Collectors
{
    ...
    {
        private readonly byte[] comStoreBuffer1;
        ...
        public MessageUtilite(int bufferSize)
        {
            if (bufferSize < 1 || bufferSize > 100000)
                throw new ArgumentException("Буфер не может быть меньше 0 или больше 100000", nameof(bufferSize));

            comStoreBuffer1 = new byte[bufferSize];
        }
        ...
        public string GetMessAtStart(byte[] rcvData, int rcvSize, byte StartChar, byte StopChar)
        {
            ...
            try
            {
                ...
                if (endIndex < startIndex)
                {
                    ...
                    comStoreBuffer1DateSize -= startIndex;
                ...
                if ((endIndex + 1) < comStoreBuffer1DateSize)
                {
                    ...
                    comStoreBuffer1DateSize -= (endIndex + 1);
